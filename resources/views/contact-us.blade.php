        ...
        <div class="col-xl-7 col-lg-6">
          ...
          <form id="contact_form" name="contact_form" action="{{ route('contact.store') }}" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="mb-3">
                  ...
                  <input name="subject" class="form-control @error('subject') is-invalid @enderror" type="text"
            ...
            <div class="mb-5">
              ...
              <button type="reset" class="theme-btn btn-style-four">
        ...
        <div class="col-xl-5 col-lg-6">
          <div class="contact-details__right">
            <div class="sec-title black">
              ...
              <div class="text">Have questions about your move? Contact our team for reliable home shifting, office
                relocation, vehicle transportation, packing, and storage services across India.</div>
            </div>
            <ul class="list-unstyled contact-details__info">
              <li>
                ...
                <div class="text">
                  ...
                  <a href="tel:980089850"><span>Free</span> +91 7070784447,   7070999547</a>
                </div>
              </li>
              <li>
                <div class="icon">
                ...
                <div class="text">
                  ...
                  <a href="mailto:info@movesmartplus.com"><span class="">info@movesmartplus.com</span></a>
                </div>
              </li>
              <li>
                <div class="icon">
                ...
                <div class="text">
                  ...
                  <span>Bhagalpur Bihar, Tilkamanghi chowk</span>
                </div>
              </li>
            </ul>
          </div>
